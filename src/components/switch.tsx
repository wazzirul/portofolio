...
export default function Switch({
  ...
  return (
    <div className="flex flex-col justify-center items-center gap-2">
      ...
      <motion.button
        className="bg-white w-[3rem] h-[3rem] drop-shadow backdrop-blur-[0.5rem] border border-slate-400 dark:border-white border-opacity-40 shadow-2xl rounded-full flex items-center justify-center dark:bg-gray-950 cursor-pointer"
        variants={switchVariants}
        initial="visible"
        whileHover="hover"
